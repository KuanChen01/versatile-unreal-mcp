...
### Quick bridge check (recommended after plugin upgrades)

With Unreal Editor running and UnrealMCP listening on `127.0.0.1:55557` (or your `UNREAL_MCP_HOST` / `UNREAL_MCP_PORT`):
